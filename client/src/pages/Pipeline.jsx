...
export default function Pipeline(){
 const {leads,loading}=useLeads(); const {users}=useUsers(); const [showModal,setShowModal]=useState(false); const [search,setSearch]=useState(""); const [member,setMember]=useState("All"); const [stage,setStage]=useState("All");
